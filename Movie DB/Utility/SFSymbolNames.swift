...
enum SFSymbolNames {
    ...
    static let categories = [
        ...
        SymbolCategory(name: "Communication", iconName: "message", symbols: communication),
        SymbolCategory(name: "Weather", iconName: "cloud.sun", symbols: weather),
        SymbolCategory(name: "Objects & Tools", iconName: "folder", symbols: objectsAndTools),
        SymbolCategory(name: "Devices", iconName: "desktopcomputer", symbols: devices),
        SymbolCategory(name: "Gaming", iconName: "gamecontroller", symbols: gaming),
        SymbolCategory(name: "Connectivity", iconName: "antenna.radiowaves.left.and.right", symbols: connectivity),
        SymbolCategory(name: "Transport", iconName: "car.fill", symbols: transport),
        SymbolCategory(name: "Human", iconName: "person.circle", symbols: human),
        SymbolCategory(name: "Nature", iconName: "leaf", symbols: nature),
        SymbolCategory(name: "Editing", iconName: "slider.horizontal.3", symbols: editing),
        SymbolCategory(name: "Text Formatting", iconName: "textformat", symbols: textFormatting),
        SymbolCategory(name: "Media", iconName: "playpause", symbols: media),
        SymbolCategory(name: "Keyboard", iconName: "command", symbols: keyboard),
        SymbolCategory(name: "Commerce", iconName: "cart", symbols: commerce),
        SymbolCategory(name: "Time", iconName: "timer", symbols: time),
        SymbolCategory(name: "Health", iconName: "heart", symbols: health),
        SymbolCategory(name: "Shapes", iconName: "square.on.circle", symbols: shapes),
        SymbolCategory(name: "Arrows", iconName: "arrow.right", symbols: arrows),
        SymbolCategory(name: "Indices", iconName: "a.circle", symbols: indices),
        SymbolCategory(name: "Maths", iconName: "x.squareroot", symbols: maths),
    ]
    
    static var allSymbols: [String] {
        categories.map(\.symbols).flatMap { $0 }
    }
    
    static let multicolor = [
