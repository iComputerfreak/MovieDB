...
class CodableTests: XCTestCase {
    ...
    func testDecodeMovieMatrix() throws {
        let companies = [
            ProductionCompany.create(id: 79, name: "Village Roadshow Pictures", logoPath: "/tpFpsqbleCzEE2p5EgvUq6ozfCA.png", originCountry: "US"),
            ProductionCompany.create(id: 372, name: "Groucho II Film Partnership", logoPath: nil, originCountry: ""),
            ProductionCompany.create(id: 1885, name: "Silver Pictures", logoPath: "/xlvoOZr4s1PygosrwZyolIFe5xs.png", originCountry: "US"),
            ProductionCompany.create(id: 174, name: "Warner Bros. Pictures", logoPath: "/IuAlhI9eVC9Z8UQWOIDdWRKSEJ.png", originCountry: "US")
        ]
        
        // Test, if the Decoding works
        let movie: TMDBData = TestingUtils.load("Matrix.json", mediaType: .movie)
        ...
        assertEqual(movie.genres, [Genre.create(id: 28, name: "Action"), Genre.create(id: 878, name: "Science Fiction")])
        ...
        let videos = [
            Video.create(key: "m8e-FF8MsqU", name: "Matrix Trailer HD (1999)", site: "YouTube", type: "Trailer", resolution: 720, language: "en", region: "US"),
            Video.create(key: "qEXv-rVWAu8", name: "The Matrix", site: "YouTube", type: "Trailer", resolution: 1080, language: "en", region: "US"),
            Video.create(key: "L0fw0WzFaBM", name: "The Matrix - 20th Anniversary - Warner Bros. UK", site: "YouTube", type: "Trailer", resolution: 1080, language: "en", region: "US")
        ]
        // Just a few. Too many to write all down
        let cast = [
            CastMember.create(id: 6384, name: "Keanu Reeves", roleName: "Thomas A. Anderson / Neo", imagePath: "/d9HyjGMCt4wgJIOxAGlaYWhKsiN.jpg"),
            CastMember.create(id: 9376, name: "Belinda McClory", roleName: "Switch", imagePath: "/wfTCwkIDJjH5k5DtuvcjP52PrLc.jpg"),
            CastMember.create(id: 1209249, name: "David O'Connor", roleName: "FedEx Man", imagePath: nil),
            CastMember.create(id: 1209257, name: "Rana Morrison", roleName: "Shaylea", imagePath: "/8ALyJkb2lith9kEVHY5IpECYSQR.jpg")
        ]
    ...
    func testDecodeMovieFightClub() throws {
        let companies = [
            ProductionCompany.create(id: 508, name: "Regency Enterprises", logoPath: "/7PzJdsLGlR7oW4J0J5Xcd0pHGRg.png", originCountry: "US"),
            ProductionCompany.create(id: 711, name: "Fox 2000 Pictures", logoPath: "/tEiIH5QesdheJmDAqQwvtN60727.png", originCountry: "US"),
            ProductionCompany.create(id: 20555, name: "Taurus Film", logoPath: "/hD8yEGUBlHOcfHYbujp71vD8gZp.png", originCountry: "DE"),
            ProductionCompany.create(id: 54051, name: "Atman Entertainment", logoPath: nil, originCountry: ""),
            ProductionCompany.create(id: 54052, name: "Knickerbocker Films", logoPath: nil, originCountry: "US"),
            ProductionCompany.create(id: 25, name: "20th Century Fox", logoPath: "/qZCc1lty5FzX30aOCVRBLzaVmcp.png", originCountry: "US"),
            ProductionCompany.create(id: 4700, name: "The Linson Company", logoPath: "/A32wmjrs9Psf4zw0uaixF0GXfxq.png", originCountry: "")
        ]
        
        // Test, if the Decoding works
        let movie: TMDBData = TestingUtils.load("FightClub.json", mediaType: .movie)
        ...
        assertEqual(movie.genres, [Genre.create(id: 18, name: "Drama")])
        ...
        let videos = [
            Video.create(key: "BdJKm16Co6M", name: "Fight Club | #TBT Trailer | 20th Century FOX", site: "YouTube", type: "Trailer", resolution: 1080, language: "en", region: "US"),
            Video.create(key: "6JnN1DmbqoU", name: "Fight Club - Theatrical Trailer Remastered in HD", site: "YouTube", type: "Trailer", resolution: 1080, language: "en", region: "US")
        ]
        // Just a few. Too many to write all down
        let cast = [
            CastMember.create(id: 819, name: "Edward Norton", roleName: "The Narrator", imagePath: "/5XBzD5WuTyVQZeS4VI25z2moMeY.jpg"),
            CastMember.create(id: 7498, name: "Eion Bailey", roleName: "Ricky", imagePath: "/hKqfGq1sPhZdQOlto0bS3igFZdP.jpg"),
            CastMember.create(id: 1657018, name: "Summer Moore", roleName: "Marla's Neighbor (uncredited)", imagePath: "/9stkBho2p586irYICd6apsb1xr9.jpg")
        ]
    ...
    func testDecodeShowBlacklist() throws {
        let companies = [
            ProductionCompany.create(id: 11073, name: "Sony Pictures Television", logoPath: "/wHs44fktdoj6c378ZbSWfzKsM2Z.png", originCountry: "US")
        ]
        let networks = [
            ProductionCompany.create(id: 6, name: "NBC", logoPath: "/o3OedEP0f9mfZr33jz2BfXOUK5.png", originCountry: "US")
        ]
        let seasons = [
            Season.create(id: 55083, seasonNumber: 0, episodeCount: 7, name: "Specials",
                   overview: "",
                   imagePath: "/jPT3J4xlQ3yF5fczAopLofHBGq3.jpg", rawAirDate: "2013-09-10"),
            Season.create(id: 55082, seasonNumber: 1, episodeCount: 22, name: "Season 1",
                   overview: "",
                   imagePath: "/ccrCgW1ukxgwBue9ptkpCEjXE6q.jpg", rawAirDate: "2013-09-23"),
            Season.create(id: 61357, seasonNumber: 2, episodeCount: 22, name: "Season 2",
                   overview: "",
                   imagePath: "/b7o8AOpZPWJO8nP4SK8RRZ2d0B0.jpg", rawAirDate: "2014-09-22"),
            Season.create(id: 70935, seasonNumber: 3, episodeCount: 23, name: "Season 3",
            ...
            Season.create(id: 80082, seasonNumber: 4, episodeCount: 22, name: "Season 4",
            ...
            Season.create(id: 91328, seasonNumber: 5, episodeCount: 22, name: "Season 5",
            ...
            Season.create(id: 112279, seasonNumber: 6, episodeCount: 22, name: "Season 6",
            ...
            Season.create(id: 132066, seasonNumber: 7, episodeCount: 19, name: "Season 7",
                   overview: "",
                   imagePath: "/zBnDzqCYOcvl8OmC53Hzd7W5hiZ.jpg", rawAirDate: "2019-10-04")
        ]
        
        // Test, if the Decoding works
        let show: TMDBData = TestingUtils.load("Blacklist.json", mediaType: .show)
        ...
        assertEqual(show.genres, [Genre.create(id: 18, name: "Drama"), Genre.create(id: 80, name: "Crime"), Genre.create(id: 9648, name: "Mystery")])
        ...
        let videos = [
            Video.create(key: "1_soL84ZDvE", name: "The Blacklist: Opening Scene - The Blacklist", site: "YouTube", type: "Clip", resolution: 1080, language: "en", region: "US"),
            Video.create(key: "-WYdUaK54fU", name: "Blacklist Season 1 - Trailer", site: "YouTube", type: "Trailer", resolution: 360, language: "en", region: "US"),
            Video.create(key: "XihA6GWIBdM", name: "The Blacklist - Season 1 Trailer [HD]", site: "YouTube", type: "Trailer", resolution: 720, language: "en", region: "US"),
            Video.create(key: "SoT5JImB1H8", name: "The Blacklist - first scene - Reddington surrenders himself to the FBI [HD]", site: "YouTube", type: "Clip", resolution: 1080, language: "en", region: "US")
        ]
        // Just a few. Too many to write all down
        let cast = [
            CastMember.create(id: 222141, name: "Megan Boone", roleName: "Elizabeth \"Liz\" Keen", imagePath: "/8SjSPu2IJQVvuM2rP0KPNmze6Dz.jpg"),
            CastMember.create(id: 13548, name: "James Spader", roleName: "Raymond \"Red\" Reddington", imagePath: "/vNreWTzTOOnLiIL4FjVrXqhlsOT.jpg"),
            CastMember.create(id: 144583, name: "Hisham Tawfiq", roleName: "Dembe Zuma", imagePath: "/go8XkwY6pbqfUDExs7o1U6O1r5u.jpg")
        ]
    ...
    func testDecodeShowGameOfThrones() throws {
        let companies = [
            ProductionCompany.create(id: 76043, name: "Revolution Sun Studios", logoPath: "/9RO2vbQ67otPrBLXCaC8UMp3Qat.png", originCountry: "US"),
            ProductionCompany.create(id: 12525, name: "Television 360", logoPath: nil, originCountry: ""),
            ProductionCompany.create(id: 5820, name: "Generator Entertainment", logoPath: nil, originCountry: ""),
            ProductionCompany.create(id: 12526, name: "Bighead Littlehead", logoPath: nil, originCountry: "")
        ]
        let networks = [
            ProductionCompany.create(id: 49, name: "HBO", logoPath: "/tuomPhY2UtuPTqqFnKMVHvSb724.png", originCountry: "US")
        ]
        let seasons = [
            Season.create(id: 3627, seasonNumber: 0, episodeCount: 53, name: "Specials",
                   overview: "",
                   imagePath: "/kMTcwNRfFKCZ0O2OaBZS0nZ2AIe.jpg", rawAirDate: "2010-12-05"),
            Season.create(id: 3624, seasonNumber: 1, episodeCount: 10, name: "Season 1",
            ...
            Season.create(id: 3625, seasonNumber: 2, episodeCount: 10, name: "Season 2",
            ...
            Season.create(id: 3626, seasonNumber: 3, episodeCount: 10, name: "Season 3",
            ...
            Season.create(id: 3628, seasonNumber: 4, episodeCount: 10, name: "Season 4",
            ...
            Season.create(id: 62090, seasonNumber: 5, episodeCount: 10, name: "Season 5",
            ...
            Season.create(id: 71881, seasonNumber: 6, episodeCount: 10, name: "Season 6",
            ...
            Season.create(id: 81266, seasonNumber: 7, episodeCount: 7, name: "Season 7",
            ...
            Season.create(id: 107971, seasonNumber: 8, episodeCount: 6, name: "Season 8",
        ...
        // Test, if the Decoding works
        let show: TMDBData = TestingUtils.load("GameOfThrones.json", mediaType: .show)
        ...
        assertEqual(show.genres, [Genre.create(id: 10765, name: "Sci-Fi & Fantasy"), Genre.create(id: 18, name: "Drama")])
        ...
        let translations = ["Arabic", "Dutch", "Turkish", "Mandarin"]
        let videos = [
            Video.create(key: "BpJYNVhGf1s", name: "Game of Thrones | Season 1 | Official Trailer", site: "YouTube", type: "Trailer", resolution: 1080, language: "en", region: "US"),
            Video.create(key: "bjqEWgDVPe0", name: "GAME OF THRONES - SEASON 1- TRAILER", site: "YouTube", type: "Trailer", resolution: 1080, language: "en", region: "US"),
            Video.create(key: "f3MUpuRF6Ck", name: "Inside Game of Thrones: A Story in Prosthetics – BTS (HBO)", site: "YouTube", type: "Behind the Scenes", resolution: 1080, language: "en", region: "US"),
            Video.create(key: "y2ZJ3lTaREY", name: "Inside Game of Thrones: A Story in Camera Work – BTS (HBO)", site: "YouTube", type: "Behind the Scenes", resolution: 1080, language: "en", region: "US")
        ]
        // Just a few. Too many to write all down
        let cast = [
            CastMember.create(id: 1223786, name: "Emilia Clarke", roleName: "Daenerys Targaryen", imagePath: "/r6i4C3kYrBRzUzZ8JKAHYQ0T0dD.jpg"),
            CastMember.create(id: 964792, name: "Jacob Anderson", roleName: "Grey Worm", imagePath: "/atkSptvQU7XdRVGrL5hiymbXwhd.jpg"),
            CastMember.create(id: 570296, name: "Joe Dempsie", roleName: "Gendry", imagePath: "/lnR0AMIwxQR6zUCOhp99GnMaRet.jpg")
        ]
