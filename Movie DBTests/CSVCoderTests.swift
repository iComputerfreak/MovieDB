...
class CSVCoderTests: XCTestCase {
    ...
    func testEncodeMediaWithIllegalCharacters() throws {
        ...
        XCTAssertEqual(lines[1], "603;movie;5;false;\"Conspiracy,Dark,Future,Illegal; Tag\";\"This note contains:;,\";watched;;;\(media1.id?.uuidString ?? "");The fight for the future begins.;The Matrix;The Matrix;Action,Science Fiction;Set in the 22nd century, The Matrix tells the story of a computer hacker who joins a group of underground insurgents fighting the vast and powerful computers who now rule the earth.;Released;1999-03-31;136;63000000;463517383;false;;;;;;;\(exporter.dateTimeFormatter.string(from: media1.creationDate));\(media1.modificationDate.map { exporter.dateTimeFormatter.string(from: $0) } ?? "")")
